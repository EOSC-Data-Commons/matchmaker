...
export interface ToolMeta {
  ...
  name: string;
  description: string;
  kind: ToolMeta_ToolKind;
  slots: Slot[];
}

export enum ToolMeta_ToolKind {
  DatasetOnly = 0,
  SlotsOnly = 1,
  FilesOnly = 2,
  SlotsAndFiles = 3,
...
export function toolMeta_ToolKindFromJSON(object: any): ToolMeta_ToolKind {
  switch (object) {
    case 0:
    case "DatasetOnly":
      return ToolMeta_ToolKind.DatasetOnly;
    case 1:
    case "SlotsOnly":
      return ToolMeta_ToolKind.SlotsOnly;
    case 2:
    case "FilesOnly":
      return ToolMeta_ToolKind.FilesOnly;
    case 3:
    case "SlotsAndFiles":
      return ToolMeta_ToolKind.SlotsAndFiles;
    case -1:
    case "UNRECOGNIZED":
    default:
      return ToolMeta_ToolKind.UNRECOGNIZED;
  }
}

export function toolMeta_ToolKindToJSON(object: ToolMeta_ToolKind): string {
  switch (object) {
...
function createBaseToolMeta(): ToolMeta {
  return { id: "", version: "", name: "", description: "", kind: 0, slots: [] };
}
...
export const ToolMeta: MessageFns<ToolMeta> = {
  ...
  fromJSON(object: any): ToolMeta {
    return {
      ...
      name: isSet(object.name) ? globalThis.String(object.name) : "",
      description: isSet(object.description) ? globalThis.String(object.description) : "",
      kind: isSet(object.kind) ? toolMeta_ToolKindFromJSON(object.kind) : 0,
  ...
  toJSON(message: ToolMeta): unknown {
    ...
    if (message.kind !== 0) {
      obj.kind = toolMeta_ToolKindToJSON(message.kind);
    }
...
function createBaseTypedValue(): TypedValue {
  return { stringValue: undefined, numberValue: undefined, boolValue: undefined, file: undefined };
}
...
export const TypedValue: MessageFns<TypedValue> = {
  encode(message: TypedValue, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.file !== undefined) {
      FileEntry.encode(message.file, writer.uint32(34).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          ...
          message.file = FileEntry.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): TypedValue {
    return {
      ...
      boolValue: isSet(object.boolValue)
        ...
        : undefined,
      file: isSet(object.file) ? FileEntry.fromJSON(object.file) : undefined,
    };
  },
  ...
  toJSON(message: TypedValue): unknown {
    ...
    if (message.file !== undefined) {
      obj.file = FileEntry.toJSON(message.file);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<TypedValue>, I>>(object: I): TypedValue {
    ...
    message.file = (object.file !== undefined && object.file !== null) ? FileEntry.fromPartial(object.file) : undefined;
    return message;
  },
};

function createBaseDatasetHandle(): DatasetHandle {
  return { url: "", title: "", description: "" };
}

export const DatasetHandle: MessageFns<DatasetHandle> = {
  encode(message: DatasetHandle, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.url !== "") {
      writer.uint32(10).string(message.url);
    }
    if (message.title !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DatasetHandle {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDatasetHandle();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): DatasetHandle {
    return {
  ...
  toJSON(message: DatasetHandle): unknown {
    const obj: any = {};
    if (message.url !== "") {
      obj.url = message.url;
    }
  ...
  create<I extends Exact<DeepPartial<DatasetHandle>, I>>(base?: I): DatasetHandle {
    return DatasetHandle.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DatasetHandle>, I>>(object: I): DatasetHandle {
    const message = createBaseDatasetHandle();
    message.url = object.url ?? "";
...
function createBaseUserInfo(): UserInfo {
  return { sub: "", email: "", name: undefined, preferredUsername: undefined };
}
...
export const UserInfo: MessageFns<UserInfo> = {
  encode(message: UserInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.preferredUsername !== undefined) {
      writer.uint32(34).string(message.preferredUsername);
    }
    return writer;
  },
...
export const LaunchToolRequest: MessageFns<LaunchToolRequest> = {
  encode(message: LaunchToolRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.dataset !== undefined) {
      DatasetHandle.encode(message.dataset, writer.uint32(26).fork()).join();
    }
    globalThis.Object.entries(message.slotsMapping).forEach(([key, value]: [string, TypedValue]) => {
      LaunchToolRequest_SlotsMappingEntry.encode({ key: key as any, value }, writer.uint32(34).fork()).join();
    });
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.dataset = DatasetHandle.decode(reader, reader.uint32());
          continue;
        }
        case 4: {
          if (tag !== 34) {
          ...
          const entry4 = LaunchToolRequest_SlotsMappingEntry.decode(reader, reader.uint32());
          if (entry4.value !== undefined) {
            message.slotsMapping[entry4.key] = entry4.value;
          }
          continue;
        }
        case 5: {
          ...
          const entry5 = LaunchToolRequest_FilesEntry.decode(reader, reader.uint32());
          if (entry5.value !== undefined) {
            message.files[entry5.key] = entry5.value;
          }
          continue;
        }
        case 6: {
  ...
  fromJSON(object: any): LaunchToolRequest {
    return {
      userInfo: isSet(object.userInfo)
        ...
        : isSet(object.user_info)
        ? UserInfo.fromJSON(object.user_info)
        : undefined,
      toolId: isSet(object.toolId)
        ...
        : "",
      dataset: isSet(object.dataset) ? DatasetHandle.fromJSON(object.dataset) : undefined,
  ...
  toJSON(message: LaunchToolRequest): unknown {
    ...
    if (message.dataset !== undefined) {
      obj.dataset = DatasetHandle.toJSON(message.dataset);
    }
    if (message.slotsMapping) {
      const entries = globalThis.Object.entries(message.slotsMapping) as [string, TypedValue][];
      if (entries.length > 0) {
        obj.slotsMapping = {};
        entries.forEach(([k, v]) => {
          obj.slotsMapping[k] = TypedValue.toJSON(v);
        });
      }
    }
    if (message.files) {
  ...
  fromPartial<I extends Exact<DeepPartial<LaunchToolRequest>, I>>(object: I): LaunchToolRequest {
    ...
    message.dataset = (object.dataset !== undefined && object.dataset !== null)
      ? DatasetHandle.fromPartial(object.dataset)
      : undefined;
    message.slotsMapping = (globalThis.Object.entries(object.slotsMapping ?? {}) as [string, TypedValue][]).reduce(
      (acc: { [key: string]: TypedValue }, [key, value]: [string, TypedValue]) => {
        if (value !== undefined) {
