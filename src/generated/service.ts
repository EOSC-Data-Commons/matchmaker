...
export interface MonitorStatusResponse {
  phase: MonitorStatusResponse_Phase;
  status?: ToolStatus | undefined;
}

/** monitoring has two Phases, running and completed */
export enum MonitorStatusResponse_Phase {
  RUNNING = 0,
  COMPLETED = 1,
  UNRECOGNIZED = -1,
}

export function monitorStatusResponse_PhaseFromJSON(object: any): MonitorStatusResponse_Phase {
  switch (object) {
    case 0:
    case "RUNNING":
      return MonitorStatusResponse_Phase.RUNNING;
    case 1:
    case "COMPLETED":
      return MonitorStatusResponse_Phase.COMPLETED;
    case -1:
    case "UNRECOGNIZED":
    default:
      return MonitorStatusResponse_Phase.UNRECOGNIZED;
  }
}

export function monitorStatusResponse_PhaseToJSON(object: MonitorStatusResponse_Phase): string {
  switch (object) {
    case MonitorStatusResponse_Phase.RUNNING:
      return "RUNNING";
    case MonitorStatusResponse_Phase.COMPLETED:
      return "COMPLETED";
    case MonitorStatusResponse_Phase.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export const LaunchRequest: MessageFns<LaunchRequest> = {
  ...
  fromJSON(object: any): LaunchRequest {
    return {
      tool: isSet(object.tool) ? ToolMeta.fromJSON(object.tool) : undefined,
      files: globalThis.Array.isArray(object?.files) ? object.files.map((e: any) => FileEntry.fromJSON(e)) : [],
    };
  },
...
function createBaseMonitorStatusResponse(): MonitorStatusResponse {
  return { phase: 0, status: undefined };
}
...
export const MonitorStatusResponse: MessageFns<MonitorStatusResponse> = {
  encode(message: MonitorStatusResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.status !== undefined) {
      ToolStatus.encode(message.status, writer.uint32(18).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): MonitorStatusResponse {
    return {
      phase: isSet(object.phase) ? monitorStatusResponse_PhaseFromJSON(object.phase) : 0,
      status: isSet(object.status) ? ToolStatus.fromJSON(object.status) : undefined,
    };
  },
  ...
  toJSON(message: MonitorStatusResponse): unknown {
    const obj: any = {};
    if (message.phase !== 0) {
      obj.phase = monitorStatusResponse_PhaseToJSON(message.phase);
    }
    if (message.status !== undefined) {
...
export const DataplayerServiceService = {
  /** launch the tool */
  launch: {
    path: "/req_packager.v1.DataplayerService/Launch" as const,
    requestStream: false as const,
    responseStream: false as const,
...
export interface DataplayerServiceServer extends UntypedServiceImplementation {
  /** launch the tool */
  launch: handleUnaryCall<LaunchRequest, LaunchResponse>;
  /** find all instance of a user, kv table search, in-memory if empharpha or using sqlite to FS if persistence needed. */
...
export interface DataplayerServiceClient extends Client {
  ...
  launch(
    ...
    callback: (error: ServiceError | null, response: LaunchResponse) => void,
  ): ClientUnaryCall;
  launch(
    request: LaunchRequest,
    metadata: Metadata,
